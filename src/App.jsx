...
const App = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-300 bg-[url('./bg-mobile-light.jpg')] dark:bg-[url('./bg-mobile-dark.jpg')]    bg-cover bg-no-repeat dark:bg-gray-800 dark:text-gray-400">
      <Header />
